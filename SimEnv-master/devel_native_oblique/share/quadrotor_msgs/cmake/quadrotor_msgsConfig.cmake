...
if("TRUE" STREQUAL "TRUE")
  set(quadrotor_msgs_SOURCE_PREFIX /root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/src/uav_simulator/Utils/quadrotor_msgs)
  set(quadrotor_msgs_DEVEL_PREFIX /root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/devel_native_oblique)
  ...
  set(quadrotor_msgs_INSTALL_PREFIX /root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/install)
...
if(NOT "/root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/devel_native_oblique/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'quadrotor_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/src/uav_simulator/Utils/quadrotor_msgs/${idir}'.  ${_report}")
    endif()
