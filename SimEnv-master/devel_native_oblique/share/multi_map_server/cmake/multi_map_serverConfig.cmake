...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/src/uav_simulator/Utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/devel_native_oblique)
  ...
  set(multi_map_server_INSTALL_PREFIX /root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/install)
...
if(NOT "/root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/devel_native_oblique/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/src/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
