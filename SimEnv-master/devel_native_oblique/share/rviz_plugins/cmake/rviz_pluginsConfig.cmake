...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/src/uav_simulator/Utils/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/devel_native_oblique)
  ...
  set(rviz_plugins_INSTALL_PREFIX /root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/src/uav_simulator/Utils/rviz_plugins/${idir}'.  ${_report}")
    endif()
