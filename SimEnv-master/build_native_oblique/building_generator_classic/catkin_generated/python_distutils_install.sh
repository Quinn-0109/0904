...
echo_and_run cd "/root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/src/building_generator_classic"
...
echo_and_run /usr/bin/env \
    ...
    "/root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/src/building_generator_classic/setup.py" \
     \
    build --build-base "/root/autodl-tmp/code/restore/0803b/overall_l0829/SimEnv-master/build_native_oblique/building_generator_classic" \
    install \
    --root="${DESTDIR-/}" \
